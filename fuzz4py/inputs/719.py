...
def main():
    ...
    # Testing annotations. This is a complex example but doesn't contain any lambda or comprehension in annotation scope.
    def test_annotation(param: list[int | str]) -> list[int]:
      return [1, 2, 3]
