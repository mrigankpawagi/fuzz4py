...
def main():
  ...
  data_types = [123, "someData", b"binaryData", None, True, [1,2,3], bytearray(10), object(), 1234567890, -10, 3.14]
  ...
  data = [1, 2, 3, "hello", True, "longer string", object(), [], {}, None, 1234567890, 3.14159,  [1,2,3, 10000], {"a":1, "b":[1,2,3]}] 
  try:
    for item in data:
      threads = []
      for i in range(5):
  ...
  malformed_data = [123, "someData", b"binaryData", None, True, [1,2,3], bytearray(10), None, object(),  b"\x00\xff", b"\x00", b"\xff", "", "   ", b"", bytearray(0)] # Added more types and edge cases
