...
def worker(data: list, lock):
    for item in data:
        ...
        try:
            ...
            possible_types = [None, 123, b"bytes", [], [1, 2, 3], {1: "a"}, (1, 2), object()]
...
def main():
    data = [1, 2, 3, 4, 5, "a", 0, -1, 1.23, None, True, 100000, -100000]
    lock = threading.Lock()
    threads = []
    for item in data:
...
def test_free_threading():
    data = [1, 2, 3, 4, 5, 12, 15, 20, -5, 0, sys.maxsize, -sys.maxsize, 10000]
    threads = []
    for _ in range(5):
...
if __name__ == "__main__":
    ...
    data_for_annotation = [(1, "a"), (2, "bb"), (3, "ccc"), (None, "extra"), (1, "invalid"), "a string", (1, 123), (0, "error"), (1, 123), (10, None), (1, "a" * 1000), (1, "invalid type")]
