...
def worker(arg):
    global shared_data
    time.sleep(0.1)
    shared_data[arg] = shared_data.get(arg, 0) + 1  # Safe access, handles missing keys
    return
...
print(jit_test(1000000))  #  Fuzzing with a large input
...
fuzz_data = [1, 2, "3", "abc", 5]  # Fuzzing with varied data types and values
