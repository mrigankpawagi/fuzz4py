...
def process_data(data: typing.List[typing.Union[int, str, float, bool, type(None)]]) -> typing.List[int]:
    result = []
    for item in data:
...
fuzz_data = [1, 2, "3", "abc", 5, "10.5", "invalid", "", "12345678901234567890", None, 3.14, True, False, [], {}]  # Add more types
