...
def main():
    ...
    data_list = [1, 2, "abc", 4.5, b'byte', 1001, 100000, -5, 0, "12345", "1000", True, False, None, [], [1,2]]
    threads = []
    ...
    try:
        ...
        print(f"DBM Error: {e}")
        # important - remove the db file if an error occurs!
        try:
            os.remove('test.db')
    ...
    try:
        ...
        # Testing certificate issue (very simplified)
