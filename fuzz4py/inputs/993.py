...
def main():
    ...
    def fuzz_replace_protocol(data):
        try:
            ...
            elif data is not None:  #Crucial check for None
...
def main_second():
    ...
    for i in range(5):
        thread_data = data[:]
        thread_data.extend(["string", 12.34, True, None, 1j, float('inf'), float('-inf'), b"bytes", object(), lambda: print("Lambda function"), "verylongstring", b'\x00'*1000])
