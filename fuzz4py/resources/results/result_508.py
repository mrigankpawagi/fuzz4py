...
OS Times: posix.times_result(user=0.03, system=0.0, children_user=0.0, children_system=0.0, elapsed=4606249.8)
b'value1'
2
...
Traceback (most recent call last):
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/dbm/sqlite3.py", line 113, in close
    self._cx.close()
    ~~~~~~~~~~~~~~^^
sqlite3.ProgrammingError: SQLite objects created in a thread can only be used in that same thread. The object was created in thread id 130354032023360 and this is thread id 130353998071360.
Traceback (most recent call last):
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/508.py", line 160, in threaded_function
    result = my_function(input1, input2)
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/508.py", line 155, in my_function
...
Traceback (most recent call last):
  ...
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/508.py", line 164, in threaded_function
    with lock:
         ^^^^
sqlite3.ProgrammingError: SQLite objects created in a thread can only be used in that same thread. The object was created in thread id 130354032023360 and this is thread id 130354008557120.
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/508.py", line 164, in threaded_function
    with lock:
         ^^^^
  File "/home/mrigankp/fuzz4py/cpython/Lib/dbm/sqlite3.py", line 123, in __exit__
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/dbm/sqlite3.py", line 113, in close
    self._cx.close()
    ~~~~~~~~~~~~~~^^
sqlite3.ProgrammingError: SQLite objects created in a thread can only be used in that same thread. The object was created in thread id 130354032023360 and this is thread id 130353987585600.
  File "/home/mrigankp/fuzz4py/cpython/Lib/dbm/sqlite3.py", line 113, in close
    self._cx.close()
    ~~~~~~~~~~~~~~^^
sqlite3.ProgrammingError: SQLite objects created in a thread can only be used in that same thread. The object was created in thread id 130354032023360 and this is thread id 130353977099840.
sqlite3.ProgrammingError: SQLite objects created in a thread can only be used in that same thread. The object was created in thread id 130354032023360 and this is thread id 130353966614080.
