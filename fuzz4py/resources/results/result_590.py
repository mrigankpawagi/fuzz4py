...
Traceback (most recent call last):
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/threading.py", line 992, in run
    ...
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/590.py", line 43, in threaded_function
    current_context = ctx.get()
LookupError: <ContextVar name='execution_context' at 0x7812fe55f650>
...
LookupError: <ContextVar name='execution_context' at 0x7812fe55f650>
Traceback (most recent call last):
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/590.py", line 88, in <module>
    main()
    ~~~~^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/590.py", line 63, in main
    with ctx.set("JIT_ON"):
         ~~~~~~~^^^^^^^^^^
