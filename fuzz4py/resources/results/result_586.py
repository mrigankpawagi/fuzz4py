...
Traceback (most recent call last):
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/threading.py", line 992, in run
    self._target(*self._args, **self._kwargs)
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/586.py", line 37, in threaded_function
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/threading.py", line 992, in run
    self._target(*self._args, **self._kwargs)
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
LookupError: <ContextVar name='execution_context' at 0x7ad565683740>
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/586.py", line 37, in threaded_function
    current_context = ctx.get()
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/586.py", line 37, in threaded_function
    current_context = ctx.get()
...
LookupError: <ContextVar name='execution_context' at 0x7ad565683740>
Traceback (most recent call last):
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/586.py", line 142, in <module>
    main()
    ~~~~^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/586.py", line 58, in main
    with ctx.set("JIT_ON"):
         ~~~~~~~^^^^^^^^^^
