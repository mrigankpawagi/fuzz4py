Return Code: 0
Stdout: Thread Error: invalid literal for int() with base 10: b'byte'
...
Time results from os.times(): posix.times_result(user=0.05, system=0.01, children_user=0.0, children_system=0.0, elapsed=4605106.49)
SSL context created successfully
SSL context created successfully with client auth

Stderr: Exception in thread Thread-14 (threaded_function):
