...
posix.times_result(user=0.06, system=0.0, children_user=0.0, children_system=0.0, elapsed=4606719.88)
...
Traceback (most recent call last):
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/threading.py", line 992, in run
    ...
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/811.py", line 16, in my_function
    total += i
