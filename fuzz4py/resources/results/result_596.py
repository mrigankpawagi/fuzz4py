...
Traceback (most recent call last):
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/threading.py", line 992, in run
    ...
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/596.py", line 53, in threaded_function
    current_context = ctx.get()
LookupError: <ContextVar name='execution_context' at 0x73604fd87a60>
Traceback (most recent call last):
Traceback (most recent call last):
  File "/home/mrigankp/fuzz4py/cpython/Lib/threading.py", line 1041, in _bootstrap_inner
    self.run()
...
LookupError: <ContextVar name='execution_context' at 0x73604fd87a60>
Traceback (most recent call last):
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/596.py", line 147, in <module>
    main()
    ~~~~^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/596.py", line 74, in main
    with ctx.set("JIT_ON"):
         ~~~~~~~^^^^^^^^^^
