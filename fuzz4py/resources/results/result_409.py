Return Code: 0
Stdout: os.times() took: 1.7739948816597462e-06
...
Traceback (most recent call last):
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/threading.py", line 992, in run
    ...
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/409.py", line 37, in <lambda>
    thread = threading.Thread(target=lambda x=data[i]: jit_sensitive_function(x), args=())
                                                       ~~~~~~~~~~~~~~~~~~~~~~^^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/409.py", line 28, in jit_sensitive_function
