Return Code: 0
Stdout: os.times() took: 2.3529864847660065e-06
...
Traceback (most recent call last):
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/threading.py", line 1041, in _bootstrap_inner
    self.run()
    ~~~~~~~~^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/410.py", line 37, in <lambda>
  ...
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/410.py", line 37, in <lambda>
    thread = threading.Thread(target=lambda x=data[i]: jit_sensitive_function(x))
                                                       ~~~~~~~~~~~~~~~~~~~~~~^^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/410.py", line 28, in jit_sensitive_function
