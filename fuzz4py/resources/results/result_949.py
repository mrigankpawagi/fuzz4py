Return Code: 0
Stdout: Error from thread 1: division by zero
...
Traceback (most recent call last):
  ...
  File "/home/mrigankp/fuzz4py/cpython/Lib/threading.py", line 992, in run
    ...
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/mrigankp/fuzz4py/fuzz4py/inputs/949.py", line 37, in worker
